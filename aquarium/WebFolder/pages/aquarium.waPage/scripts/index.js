...
// eventHandlers// @lock
	...
	{// @endlock
		$$('cmpaquaria').loadComponent('/components/cmp_fotos.waComponent');
	};// @lock

	menu_co2.click = function menu_co2_click (event)// @startlock
	{// @endlock
		$$('cmpaquaria').loadComponent('/components/cmp_co2.waComponent');
	};// @lock

	menu_aquaria.click = function menu_aquaria_click (event)// @startlock
	{// @endlock
		$$('cmpaquaria').loadComponent('/components/cmp_aquaria.waComponent');
	};// @lock

	menu_redfieldratio.click = function menu_redfieldratio_click (event)// @startlock
	{// @endlock
		$$('cmpaquaria').loadComponent('/components/cmp_redfieldratio.waComponent');
	};// @lock

	menu_metingen.click = function menu_metingen_click (event)// @startlock
	{// @endlock
		$$('cmpaquaria').loadComponent('/components/cmp_metingen.waComponent');
	};// @lock

	menu_eigenaren.click = function menu_eigenaren_click (event)// @startlock
	{// @endlock
		$$('cmpaquaria').loadComponent('/components/cmp_eigenaren.waComponent');
	};// @lock
